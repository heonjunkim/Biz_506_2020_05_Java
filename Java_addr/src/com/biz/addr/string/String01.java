...
public class String01 {
	public static void main(String[] args) {
		 ...
		 * 문자열이 담긴 변수영역의 주소를 갖고 있는 변수 영역 이렇게 2개가 생성된다.
		 * 한곳은 실제 값이 담기고, 한곳은 주소가 담긴다.
		 * 
		 * 문자열을 == 비교연산자로 비교를 하면
		 * 원칙은 주소로 비교를하나, 어떤때는 문자열 값으로 비교하기도 하고
		 * 어떤때는 주소로 비교를 한다. 
		 * 
		 ...
		 * 그중 가장 많이 사용하는 method 가 바로 문자열 변수의 값을 비교하는 equals() method이다.
		 * 
		 * !!equals()!!
		...
		System.out.println("Korea".equalsIgnoreCase("KOREA"));   // 대소문자(어떤형태이든) 관계없이 그 문자가 같냐를 먼저 물음 true
