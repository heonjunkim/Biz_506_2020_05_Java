...
public class Grade_02 {
	...
	public static void main(String[] args) {
		 ...
		 *배열에 저장되는 값을 추가, 삭제 함으로써 자동으로 배열이 생성된다.
		 *
		...
		// score
		// int[][] score : score 배열을 가로세로 방향으로 선언 하겠다.
		//                         =2차원 배열, Table Array=
		...
		// 세로 방향으로 5번위치, 가로방향으로 2번위치 값 90을 저장하라
		score[5][2] = 90;
		
		Random rnd = new Random();
		
		// index 를 줄여서 임시로 사용하기 위한 변수명
		 ...
		 *  키워드 변수, 필드변수, 맴버변수
		 *  배열의 개수가 궁금할때 일일히 세어보지 않아도 알수 있게 해주는
		 *  키워드 변수이다.
		 */
