 ...
 * 객체 : 데이터를 저장하는 용도외에 다양한 method를 통하여  
...
public class StringEx_01 {
	public static void main(String[] args) {
		...
		System.out.println( strNation.toUpperCase() );  // 대문
		...
		// strNation 문자열에 korea 라는 문자열이 들어잇냐?
		...
		// 문자열을  객체 변수에 담지 않고 바로 대문자로 바꾸고 싶을때
		System.out.println("koRea".toUpperCase());
		
		// 문자열을 대문자로 모두 바꾸어 srt1변수에 담아라
