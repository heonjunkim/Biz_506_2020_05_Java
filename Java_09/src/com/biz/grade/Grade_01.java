...
public class Grade_01 {
	...
	public static void main(String[] args) {
		 ...
		 * 이후에 보관된 값을 읽어서(꺼내서) 다른 연산에 활용하기 위함
		 * 1. 사용하기전에 반드시 선언이 되어 있어야 한다.
		 * 2. 값을 읽기 전에 반드시 초기화(어떤 값을 보관하는 절차, 코드)가 
		 *      되어 있어야 한다.
		 * 3. 초기화가 되지 않은 변수는 저장,할당,보관만 할수 있다.
		 * 4. 어떤변수에 보관중인 값은 선언된 또다른 변수로 복사할 수 있다.
		...
		// 변수 사용에 불가한 코드
		// 1.변수는 연산자등이 부착되지 않은 상태로 단독으로 명령문을 이룰수 없다. 
		// intNum;
